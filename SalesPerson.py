...
#        None
    ...
    def sell_pants(self, newPants):
        self.pants_sold.append(newPants)
...
###
    ...
    def display_sales(self):
        ...
        for pants in self.pants_sold:
            messages.append("color: "+pants.color+" , waist_size:"+pants.waist_size+ " , length:"+pants.length+" , price:"+pants.price+"\n")
        print(messages)
